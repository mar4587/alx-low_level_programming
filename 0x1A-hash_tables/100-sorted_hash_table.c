...
/**
 * shash_table_set - This function adds an element to
 * a sorted hash table
 * @ht: pointer to the sorted hash table.
 * @key: The key to add - cannot be
 * an empty string
...
/**
 * shash_table_get - This function retrieve the
...
/**
 * shash_table_print - Prints a sorted hash table in
 * order.
 * @ht: A pointer to the sorted hash table.
 */
void shash_table_print(const shash_table_t *ht)
